...
" Colors for the User Interface.
    ...
    exec "hi Normal         cterm=NONE   ctermfg=231   ctermbg=233"
    exec "hi NonText        cterm=NONE   ctermfg=230   ctermbg=black"
    ...
    exec "hi Conditional    cterm=BOLD   ctermfg=173  ctermbg=NONE"

    exec "hi Repeat         cterm=BOLD   ctermfg=208  ctermbg=NONE"
    exec "hi Repeat         cterm=BOLD   ctermfg=173  ctermbg=NONE"
    ...
    exec "hi Folded         cterm=NONE ctermfg=233 ctermbg=236"
	 exec "hi Search ctermbg=11 ctermfg=240"
    "exec "hi pythonFunction cterm=none ctermfg=231"
    "exec "hi pythonFunction ctermbg=233 ctermfg=231"
	 exec "hi pythonSpaceError ctermbg=234"	
endif
" And finally.
